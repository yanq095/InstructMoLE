...
from omnicontext_score import OmniContextScore
...
if __name__ == "__main__":
    ...
    parser.add_argument("--openai_key", type=str, default="Your API Key")
    parser.add_argument("--test_data", type=str, default="dataset/OmniContext")
